...
export interface RouteOption { route_name: string; distance: number; travel_time: number; risk_score: number; calculated_score?: number; status?: string; geometry?: [number, number][]; }
